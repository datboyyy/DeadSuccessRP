...
Citizen.CreateThread(function()
    while true do
      ...
      if #toDelete > 0 then
        TriggerServerEvent('peds:rogue', toDelete)
      else
        MarkedPeds = {}
      end
...
RegisterNetEvent('peds:rogue:delete')
AddEventHandler('peds:rogue:delete', function(pNetId)
...
RegisterNetEvent('peds:decor:set')
AddEventHandler('peds:decor:set', function (pNetId, pType, pProperty, pValue)
  local entity = NetworkGetEntityFromNetworkId(pNetId)
