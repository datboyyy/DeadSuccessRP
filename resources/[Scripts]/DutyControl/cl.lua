...
local dutyspot = PolyZone:Create({
    vector2(444.3235168457, -981.07708740234),
    vector2(444.15267944336, -983.09313964844),
    vector2(440.09097290039, -982.7490234375),
    vector2(440.22830200195, -981.29058837891)
}, {
    name = "duty_spot",
    minZ = 29.7,
    maxZ = 31.97,
