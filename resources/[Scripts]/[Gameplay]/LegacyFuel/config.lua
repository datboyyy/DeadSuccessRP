...
Config.Strings = {
	...
	EToRefuel = "Press E to refuel vehicle",
	JerryCanEmpty = "Jerry can is empty",
	FullTank = "Tank is full",
	PurchaseJerryCan = "Press E to purchase a jerry can for ~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Press E to cancel the fueling",
	CancelFuelingJerryCan = "Press E to cancel the fueling",
	NotEnoughCash = "Not enough cash",
	RefillJerryCan = "Press E  to refill the jerry can for ",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Press E to grab a jerry can"
	Config.Strings.RefillJerryCan = "Press E  to refill the jerry can"
end
