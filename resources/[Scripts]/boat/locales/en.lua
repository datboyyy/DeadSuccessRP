Locales['en'] = {
  -- shop
  ['boat_shop'] = 'boat shop',
  ['boat_shop_open'] = 'press ~INPUT_CONTEXT~ to access the boat shop.',
  ...
  -- garage
  ['garage'] = 'boat garage',
  ['garage_open'] = 'press ~INPUT_CONTEXT~ to access your boat garage.',
  ['garage_store'] = 'press ~INPUT_CONTEXT~ to store the boat in your garage.',
  ...
  ['license_nomoney'] = 'you cannot afford the Boat License!',
