...
Config.Zones = {
	...
	Garages = {
		...
		{ -- Vice  City
			GaragePos  = vector3(6414.36, -910.07, 7.07),
			SpawnPoint = vector4(6357.74, -981.68, 1.4, 109.85),
			StorePos   = vector3(6337.14, -995.84, 0.91),
			StoreTP    = vector4(6414.36, -910.07, 7.07, 109.85)
		},
