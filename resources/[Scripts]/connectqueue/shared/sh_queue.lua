...
Queue.MaxPlayers = GetConvarInt("sv_maxclients", 250)
...
local function playerConnect(name, setKickReason, deferrals)
        ...
        while connecting do
            ...
            deferrals.presentCard({
                ...
                body = {
                    {
                        type = "Image",
                        url = "https://cdn.discordapp.com/attachments/675879684818337813/737203934057201664/ezgif.com-gif-to-apng.png",
                        size = "Stretch",
                        id = "https://cdn.discordapp.com/attachments/675879684818337813/737203934057201664/ezgif.com-gif-to-apng.png",
                        width = "700px",
                        height = "300px",
                        isVisible = "true",
                    },
                    ...
                    {
                        type = "TextBlock",
                        text = 'Check out our Discord and Website Below',
                        wrap = true,
                        horizontalAlignment = "Center",
                        height = "stretch",
                        fontType = "Monospace",
                        ...
                        actions = {
                            {
                                ...
                                title = "Discord",
                                style = "positive",
                                url = "https://discord.gg/bx9JgN8Amp"
                            }
                        },
                        horizontalAlignment = "Center",
                        height = "stretch",
                        ...
                        actions = {
                            {
                                type = "Action.OpenUrl",
                                title = "Website",
                                url = "https://www.deadsuccess.com"
                            }
                        }
                    }
                },
                backgroundImage = {
                    url = "https =//i.imgur.com/vcilfLG_d.webp?maxwidth=760&fidelity=grand",
                    horizontalAlignment = "Center"
                }
            })
        end
    ...
    local defferaltest = {
        ...
        body = {
           {
            type = "Image",
            url = "https://i.gyazo.com/1dc984d2798690aef664c7f65295b75e.gif",
            size = "Stretch",
            id = "https://i.gyazo.com/1dc984d2798690aef664c7f65295b75e.gif",
            width = "400px",
            height = "100px",
            isVisible = "true",
            },
