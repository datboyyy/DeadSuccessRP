...
RegisterServerEvent('sway_scoreboard:AddPlayer')
AddEventHandler("sway_scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("sway_scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("sway_scoreboard:AddAllPlayers", source, data, recentData)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("sway_scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("sway_scoreboard:RemoveRecent", -1, plyid)
end)
