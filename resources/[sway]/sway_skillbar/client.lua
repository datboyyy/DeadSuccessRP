...
RegisterCommand('testtaskbar', function()
    ...
    --local finished = exports["sway_skillbar"]:taskBar(4000,math.random(5,15))
...
RegisterCommand('testtaskbar2', function()
    ...
    if finished ~= 100 then
        ...
        --local finished2 = exports["sway_skillbar"]:taskBar(6000,math.random(5,15))
...
RegisterCommand('testtaskbar3', function()
    ...
    if finished ~= 100 then
        ...
        if finished2 ~= 100 then
            ...
            --local finished3 = exports["sway_skillbar"]:taskBar(6000,math.random(5,15))
