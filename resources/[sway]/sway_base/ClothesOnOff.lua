...
AddEventHandler("mask", function()
    ...
    TriggerServerEvent('3dme:shareDisplay', "Takes off any facial obscurities.")
    ...
    Citizen.Wait(500)
    TriggerServerEvent('3dme:shareDisplay', "Puts on Mask")
...
AddEventHandler("hat", function()
    ...
    if not hat then 
    hat = true
    TriggerServerEvent('3dme:shareDisplay', "Takes Hat Off")
    ...
    hat = false
    TriggerServerEvent('3dme:shareDisplay', "Puts on Hat")
...
AddEventHandler("briller", function()
    ...
    if not briller then
    briller = true 
    TriggerServerEvent('3dme:shareDisplay', "Takes of Glasses")
    ...
    briller = false
    TriggerServerEvent('3dme:shareDisplay', "Puts on Glasses")
...
AddEventHandler("vest", function()
    ...
    if not vest then
    vest = true
    TriggerServerEvent('3dme:shareDisplay', "Takes off Vest")
    ...
    vest = false
    TriggerServerEvent('3dme:shareDisplay', "Puts on Vest")
    TaskPlayAnim(playerPed, "clothingshirt", "check_out_b", 3.5, -8, -1, 49, 0, 0, 0, 0) 
    Citizen.Wait(5000)
...
AddEventHandler("bukser", function()
    ...
    if not bukser then
    bukser = true
    TriggerServerEvent('3dme:shareDisplay', "Takes of Pants")
    ...
    Citizen.Wait(3000)
    SetPedComponentVariation(playerPed, 4, 34, 0, bukserPalette)
    ClearPedTasks(playerPed)
else 
    bukser = false
    TriggerServerEvent('3dme:shareDisplay', "Puts on Pants")
    TaskPlayAnim(playerPed, "clothingtrousers", "try_trousers_negative_a", 3.5, -8, -1, 49, 0, 0, 0, 0) 
    Citizen.Wait(3000)
...
AddEventHandler("shirt", function()
    ...
    if not shirt then
    shirt = true
    TriggerServerEvent('3dme:shareDisplay', "Takes off Shirt")
    ...
    shirt = false
    TriggerServerEvent('3dme:shareDisplay', "Puts Shirt Back On")
    TaskPlayAnim(playerPed, "clothingshirt", "check_out_b", 3.5, -8, -1, 49, 0, 0, 0, 0) 
    Citizen.Wait(1300)
...
AddEventHandler("shirtF", function()
    ...
    if not shirt then
    shirt = true
    TriggerServerEvent('3dme:shareDisplay', "Takes Shirt Off")
    undershirtDrawable, undershirtTexture, undershirtPalette = GetPedDrawableVariation(playerPed, 8), GetPedTextureVariation(playerPed, 8), GetPedPaletteVariation(playerPed, 8)
    GlovesDrawable, GlovesTexture, GlovesPalette = GetPedDrawableVariation(playerPed, 3), GetPedTextureVariation(playerPed, 3), GetPedPaletteVariation(playerPed, 3)
    shirtDrawable, shirtTexture, shirtPalette = GetPedDrawableVariation(playerPed, 11), GetPedTextureVariation(playerPed, 11), GetPedPaletteVariation(playerPed, 11)
    TaskPlayAnim(playerPed, "clothingshirt", "check_out_b", 3.5, -8, -1, 49, 0, 0, 0, 0)
    ...
    shirt = false
    TriggerServerEvent('3dme:shareDisplay', "Puts on Shirt")
    TaskPlayAnim(playerPed, "clothingshirt", "check_out_b", 3.5, -8, -1, 49, 0, 0, 0, 0) 
    Citizen.Wait(1300)
    SetPedComponentVariation(playerPed, 8, undershirtDrawable, undershirtTexture, undershirtPalette)
    SetPedComponentVariation(playerPed, 11, shirtDrawable, shirtTexture, shirtPalette)
...
AddEventHandler("bukserF", function()
    ...
    if not bukserF then
    bukserF = true
    TriggerServerEvent('3dme:shareDisplay', "Takes off Pants")
