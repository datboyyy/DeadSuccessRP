...
function updateCarTable(model, price, name)
    ...
    print('Update Car Table', json.encode(carTable))
...
AddEventHandler("car:testdrive", function()
    ...
    if not DoesEntityExist(veh) then
        TriggerEvent("notification", "Could not locate vehicle", 2)
        return
    end
    ...
    if not DoesEntityExist(veh) then
        ...
        SetVehicleLivery(veh, 0,0)
        --TriggerEvent("garage:AddKeys",veh, plt)
        ...
        TriggerEvent("notification", "A car is on the spawn point.", 2)
...
RegisterCommand('enableFinance', function()
    if PlayerData.job.name == 'cardealer' then
        ...
        TriggerEvent('notification', 'You are not a Car Dealer', 1)
    end
end)
...
RegisterCommand('commisionchange', function(source, args, rawCommand)
    if PlayerData.job.name == 'cardealer' then
        TriggerEvent('commission', args[1])
    else
        TriggerEvent('notification', 'You are not a Car Dealer', 1)
    end
end)
    ...
    for i = 1, #carspawns do
        ...
        if #(vector3(carspawns[i]["x"], carspawns[i]["y"], carspawns[i]["z"]) - GetEntityCoords(PlayerPedId())) < 2.0 then
            ...
            if IsControlJustReleased(0, 47) then
                TriggerEvent("notification", "Attempting Purchase")
                AttemptBuy(i, false)
            end
...
function AttemptBuy(tableid, financed)
    ...
    if baseprice > 10000 and not financed then
        TriggerEvent("notification", "This vehicle must be financed.", 2)
        return
    end
    ...
    for i = 1, #carspawns do
        if #(vector3(carspawns[i]["x"], carspawns[i]["y"], carspawns[i]["z"]) - GetEntityCoords(PlayerPedId())) < 2.0 then
            ...
            if IsControlJustReleased(0, 38) then
                TriggerEvent("notification", "We Opened")
...
function ButtonSelected(button)
    ...
    elseif this == "jobvehicles" or this == "compacts" or this == "imports" or this == "coupes" or this == "sedans" or this == "sports" or this == "sportsclassics" or this == "super" or this == "muscle" or this == "offroad" or this == "suvs" or this == "vans" or this == "industrial" or this == "cycles" or this == "motorcycles" then
...
function Back()
    ...
    if vehshop.currentmenu == "main" then
        CloseCreator()
    elseif vehshop.currentmenu == "jobvehicles" or vehshop.currentmenu == "compacts" or vehshop.currentmenu == "coupes" or vehshop.currentmenu == "sedans" or vehshop.currentmenu == "sports" or vehshop.currentmenu == "imports" or vehshop.currentmenu == "sportsclassics" or vehshop.currentmenu == "super" or vehshop.currentmenu == "muscle" or vehshop.currentmenu == "offroad" or vehshop.currentmenu == "suvs" or vehshop.currentmenu == "vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "motorcycles" then
        ...
        if vehshop.opened then
            ...
            for i, button in pairs(menu.buttons) do
                ...
                if cock then
                    ...
                    y = y + 0.04
                    if vehshop.currentmenu == "jobvehicles" or vehshop.currentmenu == "compacts" or vehshop.currentmenu == "imports" or vehshop.currentmenu == "coupes" or vehshop.currentmenu == "sedans" or vehshop.currentmenu == "sports" or vehshop.currentmenu == "sportsclassics" or vehshop.currentmenu == "super" or vehshop.currentmenu == "muscle" or vehshop.currentmenu == "offroad" or vehshop.currentmenu == "suvs" or vehshop.currentmenu == "vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "motorcycles" then
                        if selected then
...
AddEventHandler('FinishMoneyCheckForVeh', function(name, vehicle, price, financed)
    ...
    Wait(800)
    local realveh = GetVehiclePedIsIn(PlayerPedId())
    local plate = GetVehicleNumberPlateText(realveh)
    TriggerServerEvent('garage:addKeys', plate)
end)
