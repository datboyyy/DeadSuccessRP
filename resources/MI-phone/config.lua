...
Config.Languages = {
    ['en'] = {
        ...
        ["MAIL_TITLE"] = "Mail",
        ["MAIL_NEW"] = "You have received an Email from",

        ["ADVERTISEMENT_TITLE"] = "Advertisement",
        ["ADVERTISEMENT_NEW"] = "A new AD has been posted by",
        ["ADVERTISEMENT_EMPY"] = "You cannot post an empty AD!",
        ...
        ["BANK_NOIBAN"] = "There is no Bank ID tied to this contact!",
