...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("gen-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("gen-bennys:purchaseSuccessful")
AddEventHandler("gen-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("gen-bennys:purchaseFailed")
AddEventHandler("gen-bennys:purchaseFailed", function()
