...
$(document).ready(function() {
    ...
    window.addEventListener('click',function() {
        ...
        if (distance < HitDistance) {
            ...
            MainDigits--;
            $.post("http://dsrp-bankrobbery/thermiteclick");
...
Thermite.Failed = function() {
    if (active) $.post("http://dsrp-bankrobbery/thermitefailed");
    active = false;
    Thermite.Close();
}

Thermite.Success = function() {
    if (active) $.post("http://dsrp-bankrobbery/thermitesuccess");
    active = false;
    Thermite.Close();
}
...
Thermite.Close = function() {
    ...
    $.post('http://dsrp-bankrobbery/closethermite');
}