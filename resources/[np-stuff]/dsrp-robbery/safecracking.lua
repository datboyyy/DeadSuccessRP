...
cracking = false
RegisterNetEvent("safecracking:loop1")
AddEventHandler("safecracking:loop1", function(difficulty,functionName)
	loadSafeTexture()
	loadSafeAudio()
	difficultySetting = {}
	...
	while cracking do
		...
		DisplayHelpText("Press Shift+F Left | F right | H to crack")
