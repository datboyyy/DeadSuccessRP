...
RegisterNetEvent('banking:updateCashcid')
AddEventHandler('banking:updateCashcid', function(amount)
  cash = amount
end)

RegisterCommand('fundsincid', function()
print('cash for cid', cash)
end,false)

RegisterCommand('fetchbank', function()
  print('cash for cid', bank)
  end,false)
...
AddEventHandler('np-base:removedMoney', function(amount)
  newcash = cash - amount
  cash = newcash
end)
