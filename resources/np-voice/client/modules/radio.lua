...
function LoadRadioModule()
    ...
    exports("DecreaseRadioVolume", DecreaseRadioVolume)
     ...
     if Config.enableSubmixes then
         ...
         SetFilterParameters("radio", filters)
     end
