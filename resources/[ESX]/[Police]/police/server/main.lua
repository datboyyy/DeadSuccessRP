...
RegisterServerEvent('tp_policejob:handcuff')
AddEventHandler('tp_policejob:handcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'police' then
		TriggerClientEvent('tp_policejob:handcuff', target)
	else
		print(('esx_policejob: %s attempted to handcuff a player (not cop)!'):format(xPlayer.identifier))
	end
end)

RegisterServerEvent('tp_policejob:uncuff')
AddEventHandler('tp_policejob:uncuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

		TriggerClientEvent('tp_policejob:uncuff', target)

end)

RegisterServerEvent('tp_policejob:handcuffsoft')
AddEventHandler('tp_policejob:handcuffsoft', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)
		TriggerClientEvent('tp_policejob:softcuff', target)
...
RegisterServerEvent('sway_policejob:spawned')
AddEventHandler('sway_policejob:spawned', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
AddEventHandler('onMySQLReady', function()
	MySQL.Async.execute("UPDATE owned_vehicles SET `stored`=true WHERE `stored`=false AND `job`=@job", 
	{
		['@job'] = "police"
	})
end)
