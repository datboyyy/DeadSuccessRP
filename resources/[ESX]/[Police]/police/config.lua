...
Config.AuthorizedVehicles = {
	Shared = {
		--
		{ model = 'poltaurus', label = 'Police Taurus', price = 500 },
		{ model = 'pol8', label = 'Police BMW Bike', price = 1000 },
		{ model = 'pol9', label = 'Ford Raptor', price = 2000 },
		{ model = '2015polstang', label = 'Police Mustang', price = 2500 },
		{ model = 'pbus', label = 'Police Prison Bus', price = 2500 },
		{ model = 'polchar', label = 'Police Charger', price = 3000 },
		{ model = 'polraptor', label = 'Police Raptor2 ', price = 2000 },
		{ model = 'polschafter3', label = 'Police Unmarked Schafter ', price = 5000 },
		{ model = 'poltah', label = 'Police Tahoe  ', price = 4000 },
		{ model = 'polvic', label = 'Police Vic  ', price = 500 },
		{ model = 'polvic2', label = 'Police Vic2  ', price = 500 }
