Locales['en'] = {
  ...
  ['open_cloackroom'] = 'press ~INPUT_CONTEXT~ to changeclothes.',
  -- Armory
  ...
  ['armory'] = 'armory',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access theArmory.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ...
  ['garage_prompt'] = 'press ~INPUT_CONTEXT~ to access theVehicle Actions.',
  ...
  ['helicopter_prompt'] = 'press ~INPUT_CONTEXT~ to access theHelicopter Actions.',
  ...
  ['impound_prompt'] = 'press ~INPUT_CONTEXT~ to cancel theimpound',
  ...
  ['search_database_error_invalid'] = 'that is not avalid registration number',
  ['search_database_error_not_found'] = 'thatregistration number is not registered to an vehicle!',
  ['search_database_found'] = 'the vehicle isregistered to%s',
  -- Traffic interaction
  ...
  ['got_confiscated'] = '~y~%sx%s were confiscated by%s',
  ...
  ['police_distress_message'] = 'police attention required: OFFICER IN NEED OF URGENT ASSISTANCE!',
  -- Chat help text
