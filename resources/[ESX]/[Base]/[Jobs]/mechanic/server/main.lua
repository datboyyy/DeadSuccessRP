...
RegisterServerEvent('esx_mechanicjob:starAVACtCraft')
AddEventHandler('esx_mechanicjob:starAVACtCraft', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starAVACtCraft2')
AddEventHandler('esx_mechanicjob:starAVACtCraft2', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starAVACtCraft3')
AddEventHandler('esx_mechanicjob:starAVACtCraft3', function()
	local _source = source
