Locales['en'] = {
  ...
  ['ems_menu_pulloutcar'] = 'pull out Vehicle',
  ['ems_menu_drag'] = 'Drag Closest Player',
  ['ems_menu_small'] = 'heal small wounds',
  ['ems_menu_big'] = 'treat serious injuries',
  -- Phone
  ['alert_ambulance'] = 'alert Ambulance',
  -- Death
  ['respawn_available_in'] = 'respawn available in ~r~%s minutes %s seconds',
  ['respawn_bleedout_in'] = 'you will bleed out in ~r~%s minutes %s seconds\n',
  ['respawn_bleedout_prompt'] = 'hold [~b~E] to respawn',
  ['respawn_bleedout_fine'] = 'hold [~b~E] to respawn for $%s',
  ['respawn_bleedout_fine_msg'] = 'you paid ~r~$%s to respawn.',
  ['distress_send'] = '~w~Press [~r~G~w~] to send distress signal',
  ...
  ['not_enough_medikit'] = 'You do not have ~b~medikit.',
  ['not_enough_bandage'] = 'You do not have ~b~bandage.',
