...
Config.MaxStops	= 6 -- Total number of stops a person is allowed to do before having to return to depot.
...
Config.StopPay = 98 -- Total pay for the stop before bagpay.
...
Config.VehicleSpawn = {pos = vector3(-324.19,-1523.74, 27.53),}

Config.Zones = {
	[1] = {type = 'Zone', size = 5.0 , name = 'endmission', pos = vector3(-335.26,-1529.56, 26.58)},
	[2] = {type = 'Zone', size = 2.5 , name = 'timeclock', pos = vector3(-321.70,-1545.94, 30.02)},
